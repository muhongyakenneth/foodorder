...
<form method="post" enctype="multipart/form-data" class="form-horizontal">
	...
	<tr>
        ...
        <td><input class="form-control" type="text" name="duty" value="<?php echo $row['duty']; ?>" readonly /></td>
    </tr>
    ...
    <tr>
        ...
        <a class="btn btn-default" href="home1.php"> <span class="glyphicon glyphicon-backward"></span> cancel </a>
