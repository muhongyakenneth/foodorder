...
if(isset($_POST['btn_save_updates']))
	{
		...
		if(!isset($errMSG))
		{
		$update="update sub_menu set  Item='".$username."', price='".$userjob."', userPic='".$userpic."' WHERE id='".$id."'";
...
<form method="post" enctype="multipart/form-data" class="form-horizontal">
    ...
    <tr>
        ...
        <td><input class="form-control" type="text" name="user_name" value="<?php echo $row['Item']; ?>" required /></td>
    </tr>
    
    <tr>
    	<td><label class="control-label">Price.</label></td>
        <td><input class="form-control" type="text" name="user_job" value="<?php echo $row['price']; ?>" required /></td>
    </tr>
    
    <tr>
    	<td><label class="control-label">Item image:</label></td>
        <td>
        	<p><img src="user_images/<?php echo $row['userPic']; ?>" height="150" width="150" /></p>
    ...
    <tr>
        ...
        <a class="btn btn-default" href="add.php"> <span class="glyphicon glyphicon-backward"></span> cancel </a>
